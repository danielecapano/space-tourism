...
function DestinationCard() {
  ...
  const planet = destinations.find((dest) => dest.name === planetName);

  const { name, distance, time, src, description } = planet;
  return (
    <Layout>
      <div className='max-w-[900px]  flex flex-col desktop:flex-row desktop:justify-between items-center desktop:basis-full desktop:gap-32 grow-1'>
